...
public class UsersController : Controller
{
    ...
    public UsersController (UserPledgeContext DB)
    {
        db = DB;
    }
    ...
    public IActionResult Index()
    {
        ...
        {
            // if a something is in session, check to see if that corresponds to a valid user. if so go straight to Projects page
